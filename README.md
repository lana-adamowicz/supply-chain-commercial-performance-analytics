...
**The Impact:** Overly aggressive system deadlines artificially drop the Order Fill Rate to **76.2%**, creating a phantom inventory shortage due to a minor **0.5-day average delay**.
